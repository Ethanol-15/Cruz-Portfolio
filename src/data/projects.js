/* ============================================================
   ...
   ============================================================ */
import coachEScreenshot from '../assets/coach-e-app-scrsht.png';
import coachEVideo from '../assets/coach-e-app-video.mp4';
   const projects = [
    {
      id: 1,
      slug: 'coach-e',
      title: 'Coach E — AI Fitness Coach',
      /* badge values: ' | 'research' | 'thesis' | persona | school*/
      badge: 'personal',
      description:
      ...
      /* Add a live URL or GitHub link when ready */
