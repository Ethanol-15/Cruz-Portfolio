     ...
     return (
       ...
       >
         ...
         <p className="about__intro about__reveal">
           I don't just want things to work — I want to know{" "}
           <em>why</em> they work.
         </p>
         ...
         <div className="about__pair about__reveal">
           <div className="about__copy">
             <p className="about__body">
               ...
               somnething from scratch, tracing how a vision model processes image
               tokens,or learning how LLMs are made, I want to understand the
               system end-to-end.
             </p>
           </div>
           ...
           <div className="about__img-frame about__img-frame--coding">
             <div className="about__img-placeholder">
               <span className="about__img-placeholder-icon">
                 💻
               </span>
   
               <span className="about__img-placeholder-text">
                 coming soon
               </span>
             </div>
         ...
         <div className="about__pair about__pair--reverse about__reveal">
           <div className="about__copy">
             ...
             <a
               href="https://coach-e-coaching-website.vercel.app/"
               target="_blank"
               rel="noreferrer"
               className="about__coach-btn"
             >
               View Coaching Portfolio →
             </a>
           </div>
